...
public class UniversityStaffMemberController {
	...
	public ResponseEntity<String> removeStaff(@PathVariable("staff_id") @Valid Integer staffId) {
		...
		ResponseEntity<String> response = new ResponseEntity<String>("Staff rec deleted", HttpStatus.OK);
		return response;
	}

	
	// Updating Staff details and save to database
	...
	/**
	 * Creating table and save to database 
	 */
	@PostMapping("/staffs")
